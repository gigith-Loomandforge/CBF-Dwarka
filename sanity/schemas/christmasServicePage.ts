...
export const christmasServicePageType = defineType({
  name: "christmasServicePage",
  title: "Christmas Service Page",
  type: "document",
  groups: [
  ...
  fields: [
    defineField({
      ...
      type: "string",
      group: "hero",
      initialValue: "Christmas Service",
    ...
    defineField({
      ...
      type: "slug",
      group: "seo",
      initialValue: { current: "christmas-service" },
      options: {
        source: "title",
        maxLength: 96,
      },
    ...
    defineField({
      ...
      type: "string",
      group: "hero",
      initialValue: "Christmas Celebration",
    }),
    defineField({
      name: "summary",
      title: "Short summary",
    ...
    defineField({
      ...
      fields: [
        defineField({
          ...
          title: "Alt text",
          type: "string",
          initialValue: "CBF Dwarka Christmas Service",
        }),
      ],
    }),
    defineField({
    ...
    defineField({
      ...
      type: "number",
      group: "details",
      description: "A separate Christmas RSVP spreadsheet is used for each year.",
    ...
    defineField({
      ...
      initialValue: "Christmas Service at 10:30 AM",
    }),
    defineField({
      name: "locationName",
      title: "Location name",
    ...
    defineField({
      ...
      group: "rsvp",
      initialValue: false,
      description: "Turn this off when registration for this year's Christmas Service is closed.",
    }),
    defineField({
      name: "rsvpTitle",
      title: "RSVP title",
  ...
  preview: {
    ...
    prepare({ title, eventYear, rsvpEnabled, scheduleLabel }) {
      ...
      return {
        title: `${title || "Christmas Service"} - ${year}`,
